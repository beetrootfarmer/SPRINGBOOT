package com.example.sbs.demo.impl;
...
import com.example.sbs.demo.service.MailService;
...
public class MemberServiceImpl implements MemberService {
	...
	public Map<String, Object> join(Map<String, Object> args) {
		...
		Member newMember = new Member(id, regDate, loginId, loginPasswd, name, email, false);
