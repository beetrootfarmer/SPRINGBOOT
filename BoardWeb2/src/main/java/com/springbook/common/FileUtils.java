...
public class FileUtils {
	public List<BoardFileVO> parseFileInfo(int seq, HttpServletRequest request, MultipartHttpServletRequest mhsr) throws IOException {
		...
		while(iterator.hasNext()) {
			...
			// 파일 리스트 개수만큼 리턴할 파일 리스트에 담아주고 생성
